 ...
 * @author root
 */
public class websterc2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dignidad == 3) {
                ...
                listado = resDB.CargarPorDignidadCantonal(dignidad, 5);
                //total_actas = acDB.TotalJuntasProvincia();
                total_actas = acDB.TotalJuntasCanton(5);
            ...
            if (tipo.equals("jsp")) {
                ...
                response.sendRedirect("websterc2.jsp?tipo_eleccion=" + tipo_eleccion + "&dignidad_string=" +  URLEncoder.encode(dignidad_string,"utf-8") + "&tipo=" + tipo + "&total_votos=" + 0 + "&total_actas_ingresadas=" + total_actas_ingresadas + "&total_actas=" + total_actas + "&total_actas_faltantes=" + (total_actas - total_actas_ingresadas));
                return;
            }
